========================================================================
    APLICACIÓN DE CONSOLA: graficas_MerazMurilloMurillo Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación graficas_MerazMurilloMurillo.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación graficas_MerazMurilloMurillo.


graficas_MerazMurilloMurillo.vcxproj
...
graficas_MerazMurilloMurillo.vcxproj.filters
...
graficas_MerazMurilloMurillo.cpp
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado graficas_MerazMurilloMurillo.pch y un archivo de tipos precompilados llamado StdAfx.obj.
